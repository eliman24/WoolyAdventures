...
//                    .ignoresSafeArea()
        ...
        if correct {
            ...
            SpellingCorrectView1(correct: .constant(true), q1: .constant(false), q2: .constant(true), q3: .constant(false))
        } else if incorrect {
            //make array of things to say
            SpellingIncorrectView1(incorrect: .constant(true), q1: .constant(false), q2: .constant(true), q3: .constant(false))
        }
    }
    
    func birdSound() {
       let resourcePath = Bundle.main.url(forResource: "bird", withExtension: "mp3")
...
struct Spelling1_Q2View_Previews: PreviewProvider {
