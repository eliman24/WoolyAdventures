...
struct Math1_Q3View: View {
    ...
    var body: some View {
        ...
        if correct {
            ...
            //make array of things to say
            Math1_IncorrectView(incorrect: .constant(true), q1: .constant(false), q2: .constant(false), q3: .constant(true))
        }
    }
...
struct Math1_Q3View_Previews: PreviewProvider {
